  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-x-4 gap-y-2.5 text-sm bg-gray-50 rounded-xl p-3">
        <div>
          <span className="text-xs text-gray-500 uppercase tracking-wide">Hasta</span>
          <p className="font-bold text-gray-900">${formatAmount(lender.maxAmount)}</p>
        </div>
        <div>
          <span className="text-xs text-gray-500 uppercase tracking-wide">Plazo</span>
          <p className="font-bold text-gray-900">{lender.minDays}–{lender.maxDays}</p>
        </div>
        <div>
          <span className="text-xs text-gray-500 uppercase tracking-wide">Interés en 30 días</span>
          <p className="font-bold text-gray-900">desde {formatCurrency(750)} <span className="text-xs font-normal text-gray-500">/ $5k</span></p>
        </div>
        <div>
          <span className="text-xs text-gray-500 uppercase tracking-wide">Aprobación</span>
